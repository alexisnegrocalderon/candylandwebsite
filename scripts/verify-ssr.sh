...
check "/"                              "La próxima noche está por anunciarse." "Mansion Playroom" state,ogimage
check "/eventos"                       "Próximamente"               "Eventos y Fiestas" state
check "/entradas"                      "Todavía no hay accesos cargados" "Entradas y Precios" state
check "/nosotros"                      "experiencias"               "Quiénes Somos"
check "/blog"                          "Todo lo que conviene saber antes de salir" "Blog"
check "/blog/que-llevar"               "Tres cosas."                "Qué Llevar" ogimage
check "/panoramas"                     "Panoramas nocturnos en la Región de Valparaíso" "Panoramas Nocturnos"
check "/panoramas/vina-del-mar"        "Si vas a tomar"              "Qué Hacer en Viña" ogimage
check "/embajadores"                   "Postula"                    "Embajadores VIP"
check "/politica-de-reembolso"        "reembolso"                  "Política de Reembolso"
check "/politica-de-privacidad"        "datos personales"            "Política de Privacidad"
# gated route: 200 + noindex + client-only loading shell.
check "/admin"                         "Cargando"                  "Mansion Playroom" nocanon,noindex
# redirect layer — one row per class:
check_301 "/index.html"                "/"
check_301 "/eventos/"                  "/eventos"
check_301 "/blog/que-llevar/"           "/blog/que-llevar"
check_301 "/blog/primera-vez"         "/blog/primera-vez-que-esperar"
check_404 "/eventos/this-slug-does-not-exist"
